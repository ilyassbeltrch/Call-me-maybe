...
class FunctionCaller:
    ...
    def call(self, prompt: str) -> dict[str, Any]:
        ...
        base_ids: list[int] = self.model.encode(
            base_prompt
        ).tolist()[0]

        name_prompt = base_prompt + '\n{"name": "'
        name_ids: list[int] = self.model.encode(
            name_prompt
        ).tolist()[0]
        ...
        param_types = {
            k: v.type
            for k, v in func_def.parameters.items()
        }
